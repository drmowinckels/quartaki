...
### Markdown formatting is not being applied
  ...
  -   When in the visual editor, if typing in markdown syntax, the editor add an [escape character](https://www.wikiwand.com/en/Escape_character) to the markdown, which will not be rendered.
    - To see this, have them switch to the `source` editor in stead, and look for stray backslashes (`\`) in the markdown, this is the escape character. Have them delete that and try again. Once fixed, that can switch back to the visual editor.
    - If the learner knows a lot of plain markdown, they can also just use the source editor, but I find that the visual editor is a good way to get started. I usually switch between the two a lot.
...
Slides: [https://drmowinckels.io/quartaki/00_intro.html#/title-slide](https://drmowinckels.io/quartaki/00_intro.html#/title-slide)
...
Slides: [https://drmowinckels.io/quartaki/01_elements.html#/title-slide](https://drmowinckels.io/quartaki/01_elements.html#/title-slide)
...
Slides: [https://drmowinckels.io/quartaki/02_presentation.html#/title-slide](https://drmowinckels.io/quartaki/02_presentation.html#/title-slide)
